    ...
    <div>
      <div className="course-details-price-body">
        <p className="course-details-price">
          {" "}
          Price: {props.courseDetails?.Price} EUR{" "}
        </p>
        <Button
          variant="contained"
          ...
          onClick={async () => {
            if (props.isPurchased) {
              ...
              if (props.type === "corporateTrainee" && !request) {
                await Services.createCourseRequest(
                  props.userDetails._id,
                  props.courseDetails._id,
                  props.userDetails.Corporate
                );
                setRequest(true);
              } else if (props.type === "individualTrainee") {
                navigation(path);
