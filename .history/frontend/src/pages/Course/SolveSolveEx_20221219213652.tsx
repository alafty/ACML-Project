            ...
            return (
                ...
                <div style={{marginTop: 20}}>
                             ...
                             <h2>{this.state.Question[this.currentQuestion].Question}</h2>
                                ...
                                <button value={this.state.Question[this.currentQuestion].Choice1}   onChange={() => this.checkAnswer(this.state.Question[this.currentQuestion].Choice1,this.state.Question[this.currentQuestion])} /> 
                                                {this.state.Question[this.currentQuestion].Choice1} 
                            
                            <br />
                    
                                <button value={this.state.Question[this.currentQuestion].Choice2} onChange={() => this.checkAnswer(this.state.Question[this.currentQuestion].Choice2,this.state.Question[this.currentQuestion])}  />
                                                {this.state.Question[this.currentQuestion].Choice2}
                            
                            <br />
                            
                                <button value={this.state.Question[this.currentQuestion].Choice3}  onChange={() => this.checkAnswer(this.state.Question[this.currentQuestion].Choice3,this.state.Question[this.currentQuestion])}  />
                                                {this.state.Question[this.currentQuestion].Choice3}
                        
                            <br />
                            
                                <button value={this.state.Question[this.currentQuestion].Choice4}  onChange={() => this.checkAnswer(this.state.Question[this.currentQuestion].Choice4,this.state.Question[this.currentQuestion])} />
