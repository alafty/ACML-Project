            ...
            return (
                ...
                <div style={{marginTop: 20}}>
                            ...
                            <br />
                                ...
                                <button           style={{ "width": "400px", "marginTop": "50px", "marginLeft": "70vw" }}
 value={this.state.Question[this.currentQuestion].Choice3}  onClick={() => this.checkAnswer(this.state.Question[this.currentQuestion].Choice3,this.state.Question[this.currentQuestion])}  />
