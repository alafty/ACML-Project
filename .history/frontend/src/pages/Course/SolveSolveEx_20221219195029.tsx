            ...
            return (
                ...
                <div style={{marginTop: 20}}>
                    ...
                    {this.state.Question.map((question)=>(
                             ...
                             <label>
                                <input type="radio" value={question.Choice1} name="choices"  onSelect={() => this.checkAnswer({question})} /> 
                                                {question.Choice1} 
                            </label>
                            <br />
                            <label>
                                <input type="radio" value={question.Choice2} name="choices" onSelect={() => this.checkAnswer({question})}  />
                                                {question.Choice2}
                            </label>
                            <br />
                            <label>
                                <input type="radio" value={question.Choice3} name="choices" onSelect={() => this.checkAnswer({question})}  />
                                                {question.Choice3}
                            </label>
                            <br />
                            <label>
                                <input type="radio" value={question.Choice4} name="choices" onSelect={() => this.checkAnswer({question})} />
                                                {question.Choice4}
                            </label>
                            </div>
